export default {
  ...
  sharePopupText1: 'このWebページを友人や同僚に共有する。',
  sharePopupText2: 'ウクライナを支援する方法を知らせよう。',
  sharingText: 'ウクライナの軍隊や人道的慈善団体を支援する`',
  copyLink: 'リンクをコピー',
  copyLinkDone: 'コピー完了!',
  ...
  legalDesc1: '税金ID',
  legalDesc2: '税金IDをコピーする',
  legalDesc3: '非営利団体の登録簿に記載されているコードで確認する',
  legalFooterLink: 'ウクライナの州税サービス',
}
