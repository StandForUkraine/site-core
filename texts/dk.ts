export default {
  ...
  heroSubtitle: 'Gennemse en liste over verificerede velgørenhedsorganisationer og militære hjælpefonde for at støtte Ukraines væbnede styrker og yde humanitær bistand.',
