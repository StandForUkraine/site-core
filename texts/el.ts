export default {
  ...
  siteDescription: `Υποστηρίξτε την Ουκρανία απέναντι στη ρωσική στρατιωτική επίθεση. Κάντε δωρεά σε εγκεκριμένα οργαμώσεις για να βοηθήσετε τις Ένοπλες Δυνάμεις της Ουκρανίας ή ανθρωπιστικές οργανώσεις. Ενημερώστε το κοινό κοινοποιώντας τα ενημερωτικά μας δελτία.`,
  ...
  heroHeader: `Βοηθήστε τις Ουκρανικές Στρατιωτικές & Ανθρωπιστικές Οργανώσεις`,
