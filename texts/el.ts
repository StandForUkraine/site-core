export default {
  ...
  heroSubtitle: 'Περιηγηθείτε σε μια λίστα επαληθευμένων φιλανθρωπικών οργανώσεων και ταμείων στρατιωτικής βοήθειας για τη στήριξη των Ενόπλων Δυνάμεων της Ουκρανίας και την παροχή ανθρωπιστικής βοήθειας.',
  ...
  Press: 'Τύπος',
  Veterancy: 'Βετεράνοι',
  'Non-lethal': 'Μη θανατηφόρο',
  'Non-government': 'Μη κυβερνητικό',
  'Human Rights': 'Ανθρώπινα δικαιώματα',

  // footer
  footerHeader:
    'Το Stand for Ukraine—είναι ένας συντονιστής αξιόπιστων οργανισμών που βοηθά στην αντιμετώπιση της ρωσικής εισβολής και στην υπέρβαση των συνεπειών της.',
  footerGoals: 'Οι Στόχοι μας',
  goal1: 'Βοηθήστε τον ουκρανικό στρατό με όπλα, πυρομαχικά και προμήθειες',
  goal2: 'Αποκαταστήστε τους βετεράνους και τα θύματα του πολέμου',
  goal3: 'Στεγάστε και τροφοδοτήστε τους πρόσφυγες',
  goal4: 'Βοηθήστε παιδιά, ηλικιωμένους και άλλες ευάλωτες ομάδες',
  goal5: 'Υποστηρίξετε τον ανεξάρτητο τύπο',
  footerCreds:
