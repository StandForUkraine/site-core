export default {
  ...
  siteDescription: `Κάντε δωρεά σε Ουκρανικές στρατιωτικές και ανθρωπιστικές οργανώσεις. Περιηγηθείτε σε επαληθευμένες φιλανθρωπικές οργανώσεις και ταμεία στρατιωτικής βοήθειας για τη στήριξη των Ενόπλων Δυνάμεων της Ουκρανίας.`,
  thumbnail: `/thumbnail.png`,

  share: 'Κοινοποίησε',
  donate: 'Πρόσφερε',
  inform: 'Ενημέρωσε',
  donateButton: 'Πρόσφερε',
  spreadTheWorld: 'Spread the word',

  // AI-translated, pending native review
  heroTitle: 'Κάντε δωρεά σε Ουκρανικές Στρατιωτικές & Ανθρωπιστικές Οργανώσεις',
  heroSubtitle:
    'Περιηγηθείτε σε μια λίστα επαληθευμένων φιλανθρωπικών οργανώσεων και ταμείων στρατιωτικής βοήθειας για τη στήριξη των Ενόπλων Δυνάμεων της Ουκρανίας και την παροχή ανθρωπιστικής βοήθειας.',
  heroTagline: 'Στάσου δίπλα στην Ουκρανία απέναντι στην ολοκληρωτική ρωσική εισβολή.',

  close: 'Κλείσε',
  sharePopupTitle: 'Διαδώστε τον σκοπό',
  sharePopupText1: 'Μοιραστείτε αυτή την πηγή με τους φίλους και τους συναδέλφους σας.',
  sharePopupText2: 'Ενημερώστε τους ανθρώπους πώς να υποστηρίξουν την Ουκρανία.',
  sharingText: 'Βοηθήστε τις Ουκρανικές Στρατιωτικές & Ανθρωπιστικές Οργανώσεις #StandForUkraine',
  ...
  // footer
  footerMissionLead:
    'σας βοηθά να στηρίξετε την Ουκρανία — άμεσα, με ασφάλεια και με τους δικούς σας όρους. Βρείτε επαληθευμένες δράσεις και δώστε εκεί που μετράει περισσότερο.',
  footerGoals: 'Οι Στόχοι μας',
  goal1:
    'Να εφοδιάζονται οι ουκρανικές ένοπλες δυνάμεις με όπλα, πυρομαχικά και εξοπλισμό κατά της πλήρους κλίμακας ρωσικής εισβολής.',
  goal2: 'Να υποστηρίζονται βετεράνοι και θύματα πολέμου στην ανάρρωση.',
  goal3: 'Να παρέχονται στέγη και τροφή σε εκτοπισμένους πρόσφυγες.',
  goal4: 'Να βοηθούνται παιδιά, ηλικιωμένοι και ευάλωτες ομάδες.',
  goal5: 'Να ενισχύεται η ανεξάρτητη δημοσιογραφία.',
  footerCreds:
    'Δημιουργήθηκε από εθελοντές — μηχανικούς, σχεδιαστές, δημοσιογράφους και ακτιβιστές από την Ουκρανία και τον κόσμο.',
  footerContact: 'Επικοινωνήστε μαζί μας',
  joinUs: 'Join us',
  disclaimer:
    'Δεν επεξεργαζόμαστε δωρεές — συνδέουμε μόνο με επαληθευμένες, διαφανείς συγκεντρώσεις.',
