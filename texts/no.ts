export default {
  ...
  sharePopupText1: 'Del det her med vennene og kollegaene dine.',
  sharePopupText2: 'La folk få vite hvordan de kan støtte Ukraina.',
  sharingText: 'Hjelp det ukrainske militæret og humanitære organisasjoner #StandForUkraine',
