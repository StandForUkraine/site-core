export default {
  ...
  sharePopupText1: 'Comparta este recurso con tus amigos y colegas.',
  sharePopupText2: 'Que la gente sepa cómo apoyar a Ucrania.',
  sharingText: 'Ayuda a las Organizaciones Militares y Humanitarias Ucranianas #StandForUkraine',
