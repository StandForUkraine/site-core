export default {
  ...
  siteDescription: `Пожертвуйте украинским военным и гуманитарным организациям. Просмотрите проверенные благотворительные организации и фонды военной помощи для поддержки Вооруженных Сил Украины.`,
  ...
  heroTitle: 'Пожертвуйте украинским военным и гуманитарным организациям',
  heroSubtitle: 'Просмотрите список проверенных благотворительных организаций и фондов военной помощи для поддержки Вооруженных Сил Украины и оказания гуманитарной помощи.',
  heroTagline: 'Stand for Ukraine перед лицом полномасштабного вторжения России.',
  ...
  joinUs: 'Подписаться',
  disclaimer: 'Мы не принимаем платежи; мы просто предоставляем ссылки на страницы соответствующих организаций.',
  aboutProject: 'О проекте',
  suggestOrgLink: 'Предложить организацию',
  sharedFeedbackLink: 'Написать отзыв',
  joinFormLink: 'Присоединиться к Международному легиону',
