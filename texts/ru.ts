export default {
  ...
  siteDescription: `Поддержи украинские военные и гуманитарные организации. Проверенные фонды, которые помогают ВСУ и пострадавшим от войны.`,
  ...
  heroTitle: 'Поддержи украинские военные и гуманитарные организации',
  heroSubtitle:
    'Проверенные благотворительные и военные фонды — чтобы помочь ВСУ и людям, пострадавшим от войны.',
  heroTagline: 'Поддержи Украину во время полномасштабного вторжения России.',
  ...
  Refugees: 'Помощь беженцам',
  Press: 'Пресса',
  'Non-combat': 'Небоевая поддержка',
  NGO: 'НКО',
  'Human Rights': 'Права человека',

  // footer
  footerMissionLead:
    'помогает поддержать Украину — напрямую, безопасно и так, как тебе удобно. Находи проверенные сборы и помогай там, где это важнее всего.',
  footerGoals: 'Наши цели',
  goal1:
    'Обеспечить Вооружённые силы Украины оружием, боеприпасами и снаряжением против полномасштабного вторжения России.',
  goal2: 'Поддержать ветеранов и пострадавших от войны в восстановлении.',
  goal3: 'Дать кров и питание вынужденным переселенцам.',
  goal4: 'Помочь детям, пожилым и уязвимым группам.',
  goal5: 'Укрепить независимую журналистику.',
  footerCreds:
    'Создано волонтёрами — инженерия, дизайн, журналистика и активизм, из Украины и со всего мира.',
  footerContact: 'Связаться с нами',
  joinUs: 'Присоединяйся',
  disclaimer:
    'Мы не обрабатываем пожертвования — только связываем с проверенными и прозрачными сборами.',
  aboutProject: 'О проекте',
  suggestOrgLink: 'Предложить организацию',
  sharedFeedbackLink: 'Написать отзыв',
  footerVerifyYouControl: 'Проверить через youcontrol.com',
  footerLastReviewed: 'Последнее обновление: март 2026',
  ...
  legalDesc1:
    'ЄДРПОУ(ЕГРПОУ) – идентификационный номер юридического лица в Едином государственном реестре предприятий и организаций Украины.',
