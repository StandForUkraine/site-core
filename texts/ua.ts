export default {
  ...
  siteDescription: `Підтримай українські військові та гуманітарні організації. Перевірені фонди, які допомагають ЗСУ та постраждалим від війни.`,
  ...
  heroTitle: 'Підтримай українські військові та гуманітарні організації',
  heroSubtitle:
    'Перевірені благодійні та військові фонди — щоб допомогти ЗСУ і людям, які постраждали від війни.',
  heroTagline: 'Стань за Україну в час повномасштабного російського вторгнення.',
  ...
  Refugees: 'Допомога біженцям',
  Press: 'Преса',
  'Non-combat': 'Небойова підтримка',
  NGO: 'Громадські',
  'Human Rights': 'Права людини',

  // footer
  footerMissionLead:
    'допомагає знайти надійні способи підтримати Україну — напряму, безпечно і так, як зручно тобі. Спрямовуй допомогу туди, де від неї більше користі.',
  footerGoals: 'Наші цілі',
  goal1:
    'Забезпечити Збройні сили України зброєю, боєприпасами та спорядженням для протистояння повномасштабному вторгненню Росії.',
  goal2: 'Підтримати ветеранів і постраждалих від війни на шляху до відновлення.',
  goal3: 'Дати прихисток і нагодувати переселенців.',
  goal4: 'Допомогти дітям, людям похилого віку та іншим вразливим групам.',
  goal5: 'Зміцнити незалежну журналістику.',
  footerCreds:
    'Створено волонтерами — інженерами, дизайнерами, журналістами та активістами з України й світу.',
  footerContact: "Зв'язатись з нами",
  joinUs: 'Приєднуйтесь',
  disclaimer: 'Ми не приймаємо пожертв напряму — лише ведемо тебе до перевірених і прозорих зборів.',
  aboutProject: 'Про проєкт',
  suggestOrgLink: 'Запропонувати організацію',
  sharedFeedbackLink: 'Написати відгук',
  footerVerifyYouControl: 'Перевірити через youcontrol.com',
  footerLastReviewed: 'Останнє оновлення: березень 2026',
  ...
  legalDesc1:
    'ЄДРПОУ — ідентифікаційний номер юридичної особи в Єдиному державному реєстрі підприємств та організацій України.',
  legalDesc2: 'Скопіювати ЄДРПОУ',
  legalDesc3: 'Перевірити організацію за номером у реєстрі',
  legalFooterLink: 'Державна податкова служба України',
