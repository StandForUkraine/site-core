export default {
  ...
  heroSubtitle:
    'Перегляньте перевірені благодійні фонди та фонди військової допомоги для підтримки Збройних Сил України та надання гуманітарної допомоги.',
  heroTagline: 'Підтримай Україну перед обличчям повномасштабного вторгнення Росії.',
  ...
  // footer
  footerMissionLead:
    'допомагає знайти перевірені способи підтримати Україну — прямо, безпечно і на ваших умовах. Підтримуйте там, де це найважливіше.',
  ...
  goal2: 'Підтримати ветеранів і постраждалих від війни в одужанні.',
  goal3: 'Надати притулок і нагодувати переміщених біженців.',
  ...
  joinUs: 'Підписатись',
  disclaimer: 'Ми не обробляємо донати — лише з’єднуємо вас із перевіреними й прозорими зборами.',
