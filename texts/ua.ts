export default {
  ...
  joinUs: 'Підписатись',
  disclaimer: 'Ми не приймаємо платежі; ми лише надаємо посилання на сторінки відповідних організацій.',
  ...
  legalDesc1: 'ЄДРПОУ — ідентифікаційний номер юридичної особи в Єдиному державному реєстрі підприємств та організацій України.',
