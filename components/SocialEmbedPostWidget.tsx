    ...
    return (
      <Wrapper>
        <LazyLoad once offset={500}>
          {post.network === 'facebook' && <FacebookEmbedStyled url={post.link} />}
          {post.network === 'twitter' && <TwitterEmbedStyled url={post.link} />}
          {post.network === 'instagram' && <IntagramEmbedStyled url={post.link} />}
          {post.network === 'youtube' && <YoutubeEmbedStyled url={post.link} />}
          {post.network === 'tiktok' && <TikTokEmbedStyled url={post.link} />}
        </LazyLoad>
      </Wrapper>
    )
  }
